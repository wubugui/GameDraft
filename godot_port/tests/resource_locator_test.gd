...
func _init() -> void:
	...
	assert(locator.resolve_anim_relative("/resources/runtime/animation/player_anim/anim.json", " ./atlas.png ") == "/resources/runtime/animation/player_anim/atlas.png")
	assert(locator.resolve_anim_relative("/resources/runtime/animation/player_anim/anim.json", "../atlas.png") == "/resources/runtime/animation/player_anim/../atlas.png")
	assert(locator.resolve_anim_relative("/resources/runtime/animation/player_anim/anim.json", "/other/atlas.png") == "/resources/runtime/animation/player_anim/other/atlas.png")
	assert(locator.resolve_anim_relative("anim.json", "atlas.png") == "/anim.json/atlas.png")
	assert(locator.resolve_anim_relative("/folder/", "atlas.png") == "/folder/atlas.png")
	assert(locator.resolve_anim_relative("/resources//runtime/player/anim.json", "atlas.png") == "/resources/runtime/player/atlas.png")
	assert(locator.resolve_anim_relative("/resources/runtime/animation/player_anim/anim.json", "HTTP://host/x") == "/resources/runtime/animation/player_anim/HTTP:/host/x")
