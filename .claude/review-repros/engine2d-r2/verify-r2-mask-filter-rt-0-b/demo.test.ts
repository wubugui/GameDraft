...
function build(screenW: number, screenH: number, resolution: number, step: number, aspect: number) {
  ...
  ao.setPixelsPerCm(texW / 175); // a 60 cm wide object
...
['1920x1080 DPR1 z2.25 3:2', 1920, 1080, 1, 2.25, 1.5],
['1920x1080 DPR1 z3.2 3:2', 1920, 1080, 1, 3.2, 1.5],
['1920x1080 DPR1 z3.52 3:2', 1920, 1080, 1, 3.52, 1.5],
['1920x1080 DPR1.25 z2.25 3:2', 1920, 1080, 1.25, 2.25, 1.5],
['1920x1080 DPR1.25 z3.2 3:2', 1920, 1080, 1.25, 3.2, 1.5],
['1920x1080 DPR1.25 z3.52 3:2', 1920, 1080, 1.25, 3.52, 1.5],
['1920x1080 DPR1.5 z2.25 3:2', 1920, 1080, 1.5, 2.25, 1.5],
['1920x1080 DPR1.5 z3.2 3:2', 1920, 1080, 1.5, 3.2, 1.5],
['1920x1080 DPR1.5 z3.52 3:2', 1920, 1080, 1.5, 3.52, 1.5],
['1920x1080 DPR2 z2.25 3:2', 1920, 1080, 2, 2.25, 1.5],
['1920x1080 DPR2 z3.2 3:2', 1920, 1080, 2, 3.2, 1.5],
['1920x1080 DPR2 z3.52 3:2', 1920, 1080, 2, 3.52, 1.5],
['1280x720 DPR1.5 z2.25 3:2', 1280, 720, 1.5, 2.25, 1.5],
['1280x720 DPR1.5 z3.2 3:2', 1280, 720, 1.5, 3.2, 1.5],
['1280x720 DPR1.5 z3.52 3:2', 1280, 720, 1.5, 3.52, 1.5],
['1707x960 DPR1.5 z2.25 3:2', 1707, 960, 1.5, 2.25, 1.5],
['1707x960 DPR1.5 z3.2 3:2', 1707, 960, 1.5, 3.2, 1.5],
['1707x960 DPR1.5 z3.52 3:2', 1707, 960, 1.5, 3.52, 1.5],
['2560x1440 DPR1 z2.25 3:2', 2560, 1440, 1, 2.25, 1.5],
['2560x1440 DPR1 z3.2 3:2', 2560, 1440, 1, 3.2, 1.5],
['2560x1440 DPR1 z3.52 3:2', 2560, 1440, 1, 3.52, 1.5],
['2560x1440 DPR1.5 z2.25 3:2', 2560, 1440, 1.5, 2.25, 1.5],
['2560x1440 DPR1.5 z3.2 3:2', 2560, 1440, 1.5, 3.2, 1.5],
['2560x1440 DPR1.5 z3.52 3:2', 2560, 1440, 1.5, 3.52, 1.5],
['1512x982 DPR2 z2.25 3:2', 1512, 982, 2, 2.25, 1.5],
['1512x982 DPR2 z3.2 3:2', 1512, 982, 2, 3.2, 1.5],
['1512x982 DPR2 z3.52 3:2', 1512, 982, 2, 3.52, 1.5],
['1440x900 DPR2 z2.25 3:2', 1440, 900, 2, 2.25, 1.5],
['1440x900 DPR2 z3.2 3:2', 1440, 900, 2, 3.2, 1.5],
['1440x900 DPR2 z3.52 3:2', 1440, 900, 2, 3.52, 1.5],
['1728x1117 DPR2 z2.25 3:2', 1728, 1117, 2, 2.25, 1.5],
['1728x1117 DPR2 z3.2 3:2', 1728, 1117, 2, 3.2, 1.5],
['1728x1117 DPR2 z3.52 3:2', 1728, 1117, 2, 3.52, 1.5]
];
  const out: string[] = [];
  for (const [name, w, h, res, step, aspect] of cases) {
    it(name, () => {
      ...
      require('fs').writeFileSync('tmp/review/verify-r2-mask-filter-rt-0-b/out.txt', out.join('\n'));
