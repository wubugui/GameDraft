...
src_path = str(PATHS.runtime_images_dir / "backgrounds" / "normal_teahouse_bg.png")
depth_path = str(PATHS.runtime_images_dir / "backgrounds" / "normal_teahouse_bg_depth.png")
...
_PIPELINE_OUT = PATHS.editor_projects_root / "misc_media" / "_pipeline_result.png"
_PIPELINE_OUT.parent.mkdir(parents=True, exist_ok=True)
result.save(str(_PIPELINE_OUT))
print(f"Saved {_PIPELINE_OUT} - check visually.")
print("Pipeline OK.")
