...
> **已被取代(2026-08-16 制作人审批的开场落地版)**:本卡重排的是"开场第一单",而开场已改成
> 骗定金 → 赌坊输光 → 空山长明灯(见 [母卡横幅](2026-06-22-beishi-mundane-eerie-redesign.md))。
> 路倒 / 淹尸两单的 flow 与对话仍在数据里(对话文件已改名 `线外_*`),属主线外内容;
> 要动它们以现行数据为准,本卡的"落点"一段只是 07-12 当时的快照。
