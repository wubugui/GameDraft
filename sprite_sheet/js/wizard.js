    ...
    if (stepNumber === 2) {
      ...
      if (!state.selectedStyle || !state.uploadedImage) {
        ...
        if (styledImagePreview) {
          styledImagePreview.src = '../resources/editor_projects/sprite_sheet_media/media/loading.svg';
    ...
    stylesGrid.innerHTML = styles.map(style => {
      ...
      const getImagePath = (style) => {
        ...
        if (style.id === 'original') {
          return '../resources/editor_projects/sprite_sheet_media/media/style_previews/placeholder.svg';
        }
        ...
        return `../resources/editor_projects/sprite_sheet_media/media/style_previews/${style.id}.png`;
      };
        ...
        <div class="flex flex-col">
          <div class="w-full aspect-square bg-gray-900/80 rounded mb-2 flex items-center justify-center overflow-hidden">
            <img src="${imagePath}" 
                 ...
                 onerror="this.onerror=null; this.src='../resources/editor_projects/sprite_sheet_media/media/style_previews/placeholder.svg';">
          </div>
...
function hideStyleCardLoading(card) {
  ...
  if (imgContainer && generatedStyle && generatedStyle.imageUrl) {
    ...
    const imagePath = `../resources/editor_projects/sprite_sheet_media/media/style_previews/${styleId}.png`;
...
async function generateSingleStyle(styleId) {
  ...
  if (selectedCard) {
    ...
    if (imgContainer) {
      ...
      imgContainer.innerHTML = `<img src="../resources/editor_projects/sprite_sheet_media/media/loading.svg" alt="Loading..." class="w-full h-full p-4">`;
    }
  }
  ...
  if (selectedStyleImage && state.selectedStyle === styleId) {
    selectedStyleImage.src = '../resources/editor_projects/sprite_sheet_media/media/loading.svg';
  ...
  try {
    ...
    if (selectedStyleImage && state.selectedStyle === styleId) {
      ...
      selectedStyleImage.src = '../resources/editor_projects/sprite_sheet_media/media/style_previews/placeholder.svg';
...
function updateSelectedStylePreview(card) {
  ...
  if (cardImage) {
    ...
    selectedStyleImage.onerror = function() {
      this.onerror = null;
      this.src = `../resources/editor_projects/sprite_sheet_media/media/style_previews/placeholder.svg`;
    };
  }
...
function handleImageUpload(e) {
  ...
  if (previewContainer) {
    ...
    if (preview) {
      preview.src = '../resources/editor_projects/sprite_sheet_media/media/loading.svg'; // Show loading placeholder
    }
  }
...
function updateFinalPreviewImages() {
  ...
  if (finalImagePreview) {
    if (state.uploadedImageUrl) {
      ...
      finalImagePreview.src = '../resources/editor_projects/sprite_sheet_media/media/style_previews/placeholder.svg';
    }
  }
  ...
  if (finalStylePreview && state.selectedStyle) {
    ...
    if (generatedStyle && generatedStyle.imageUrl) {
      ...
      finalStylePreview.src = `../resources/editor_projects/sprite_sheet_media/media/style_previews/${state.selectedStyle}.png`;
    ...
    if (actionPreview) {
      actionPreview.innerHTML = `
        <div class="flex flex-col items-center justify-center p-4">
          <img src="../resources/editor_projects/sprite_sheet_media/media/loading.svg" alt="Loading..." class="w-16 h-16 mb-4">
        ...
        <div class="flex items-center gap-3 mt-3">
          ...
          ${inProgress ? 
            `<span class="text-xs px-2 py-1 bg-blue-900/30 text-blue-400 rounded flex items-center">
              <img src="../resources/editor_projects/sprite_sheet_media/media/loading.svg" alt="Loading..." class="w-4 h-4 mr-1">
            ...
            return `
              <div class="frame-container relative bg-gray-900/50 p-2 rounded-lg border border-blue-500/30 hover:border-blue-500/50 transition-colors">
                ...
                <div class="w-full aspect-square flex items-center justify-center bg-gray-800/50 rounded">
                  <img src="../resources/editor_projects/sprite_sheet_media/media/loading.svg" alt="Loading..." class="w-12 h-12">
                </div>
                <div class="mt-2 text-xs text-gray-500 px-1">
                  ${actionInfo.framePrompts && actionInfo.framePrompts[index] ? actionInfo.framePrompts[index] : ''}
                </div>
  ...
  if (styledImagePreview) {
    ...
    try {
      ...
      if (generatedStyle && generatedStyle.imageUrl) {
        ...
        styledImagePreview.src = '../resources/editor_projects/sprite_sheet_media/media/style_previews/placeholder.svg';
