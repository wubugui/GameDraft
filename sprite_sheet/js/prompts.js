...
export const STYLE_DEFINITIONS = {
  original: {
    ...
    iconUrl: '../resources/editor_projects/sprite_sheet_media/media/style_previews/original.png',
    technicalSpecs: [
  ...
  pixelart: {
    ...
    base: 32,
    gutter: 1,
    iconUrl: '../resources/editor_projects/sprite_sheet_media/media/style_previews/stardew_valley.png',
  ...
  celshaded: {
    ...
    base: 256,
    gutter: 2,
    iconUrl: '../resources/editor_projects/sprite_sheet_media/media/style_previews/breath_wild.png',
  ...
  lowpoly: {
    ...
    base: 192,
    gutter: 2,
    iconUrl: '../resources/editor_projects/sprite_sheet_media/media/style_previews/genshin.png',
  ...
  handdrawn: {
    ...
    base: 128,
    gutter: 2,
    iconUrl: '../resources/editor_projects/sprite_sheet_media/media/style_previews/hollow_knight.png',
  ...
  cartoon: {
    ...
    base: 160,
    gutter: 2,
    iconUrl: '../resources/editor_projects/sprite_sheet_media/media/style_previews/fall_guys.png',
  ...
  retro: {
    ...
    base: 32,
    gutter: 1,
    iconUrl: '../resources/editor_projects/sprite_sheet_media/media/style_previews/retro.png',
  ...
  fighter: {
    ...
    base: 120,
    gutter: 4,
    iconUrl: '../resources/editor_projects/sprite_sheet_media/media/style_previews/arcade_fighter.png',
  ...
  modern: {
    ...
    base: 96,
    gutter: 2,
    iconUrl: '../resources/editor_projects/sprite_sheet_media/media/style_previews/flat_cartoon.png',
