...
class BrowserWindow(QMainWindow):
    ...
    def _after_op(
        ...
        if r.failed and self._bar:
            self._bar.showMessage(
                f"部分失败: {len(r.failed)} 项。见 resources/editor_projects/editor_data/asset_browser_ops.jsonl",  # noqa: E501
                8000,
            )
    ...
    def _build_menus_and_toolbar(
        ...
        m2.addAction("操作日志: resources/editor_projects/editor_data/asset_browser_ops.jsonl", lambda: None)
