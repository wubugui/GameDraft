...
| warn | drift-risk | .cursor/skills/gameplay-iteration/SKILL.md:58 | `docs/玩法功能需求清单.md` is about 35 days newer than this file. | Check whether the skill/workflow still describes the current implementation. |
| warn | drift-risk | .cursor/skills/push-gamedraft-story-temp-proxy/SKILL.md:20 | `.git/config` is about 35 days newer than this file. | Check whether the skill/workflow still describes the current implementation. |
...
| warn | drift-risk | artifact/cursor-workflow-guide.md:138 | `src/core/Game.ts` is about 36 days newer than this file. | Check whether the skill/workflow still describes the current implementation. |
...
| info | missing-lifecycle | .cursor/skills/agent-docs-cli/SKILL.md:1 | No status/owner/last-verified style metadata was detected. | Consider adding status, owner, and last verified fields once the registry format is settled. |
| info | possible-overlap | .cursor/skills/agent-docs-cli/SKILL.md:1 | `.cursor/skills/agent-docs-cli/SKILL.md` and `.cursor/skills/agent-docs-cli/SKILL.md` have token overlap score 1.00. | Compare triggers and decide whether they should be split more clearly, merged, or cross-linked. |
...
| package_script | package-script.test-godot-dialogue-visuals | npm run test:godot-dialogue-visuals | package.json | package_json |
| package_script | package-script.test-godot-fade-visuals | npm run test:godot-fade-visuals | package.json | package_json |
| package_script | package-script.test-godot-minigame-visuals | npm run test:godot-minigame-visuals | package.json | package_json |
| package_script | package-script.test-godot-scene-visuals | npm run test:godot-scene-visuals | package.json | package_json |
| package_script | package-script.test-godot-visual-parity | npm run test:godot-visual-parity | package.json | package_json |
...
| skill | claude-skill.agent-docs-cli | agent-docs-cli(薄壳) | .cursor/skills/agent-docs-cli/SKILL.md | cursor_skill |
