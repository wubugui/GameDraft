...
用法：
    .\\.tools\\Python311\\python.exe -m tools.chronicle_sim_v3._realtest_smoke provider
    .\\.tools\\Python311\\python.exe -m tools.chronicle_sim_v3._realtest_smoke agent-stub
    .\\.tools\\Python311\\python.exe -m tools.chronicle_sim_v3._realtest_smoke agent-real
"""
