 ...
 * 没有也行:`npx vite --config tools/render_parity/vite.config.ts`,浏览器打开给出的地址,页面自己出表和缩略图。
...
function loadPlaywright() {
  ...
  try {
    ...
    console.error('或者手动:npx vite --config tools/render_parity/vite.config.ts,浏览器打开给出的地址。');
    process.exit(2);
  }
}
...
try {
  ...
  const params = new URLSearchParams({ images: '0' });
