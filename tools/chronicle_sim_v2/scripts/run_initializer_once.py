...
用法（在 GameDraft 根目录，cmd）::
    ...
    set PYTHONPATH=%CD%
    .\\.tools\\Python311\\python.exe tools\\chronicle_sim_v2\\scripts\\run_initializer_once.py <run_dir>
    .\\.tools\\Python311\\python.exe tools\\chronicle_sim_v2\\scripts\\run_initializer_once.py <run_dir> --stub
