...
在 GameDraft 根目录（cmd）::
    ...
    set PYTHONPATH=%CD%
    .\\.tools\\Python311\\python.exe tools\\chronicle_sim_v2\\scripts\\run_simulation_once.py <run_dir> --week 1
    .\\.tools\\Python311\\python.exe tools\\chronicle_sim_v2\\scripts\\run_simulation_once.py <run_dir> --from 1 --to 3
