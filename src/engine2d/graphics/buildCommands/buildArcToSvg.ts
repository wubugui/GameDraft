/**
 * SVG 风格椭圆弧(拆成贝塞尔再自适应细分)。移植自 PixiJS v8.17(MIT):
 * scene/graphics/shared/buildCommands/buildArcToSvg。
 */
...
function approxUnitArc(ang1: number, ang2: number): PointData[] {
...
const getArcCenter = (
  ...
  largeArcFlag: number, sweepFlag: number, sinPhi: number, cosPhi: number, pxp: number, pyp: number,
  out2: typeof out,
): void => {
