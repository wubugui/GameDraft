...
export class DialogueUI {
   ...
   * 名牌与立绘同侧：立绘在左则随 inset 右移，在右则贴右缘内侧。
   */
  private layoutSpeaker(): void {
    ...
    const plateX = this.currentSide === 'right'
      ? this.renderer.screenWidth - BOX_MARGIN - 12 - this.currentInset - plateW
      : BOX_MARGIN + 12 + this.currentInset;
